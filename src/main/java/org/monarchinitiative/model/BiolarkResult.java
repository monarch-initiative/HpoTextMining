...
/**
 * The server performing text-mining analysis returns results as a collection of JSON objects. This class serves as
 * a model for those objects.
...
public class BiolarkResult {
    ...
    /**
     * Create instance from single response object. This instance contains coordinates of the "term-containing" substring
     ...
     * @param term     identified {@link Term}
